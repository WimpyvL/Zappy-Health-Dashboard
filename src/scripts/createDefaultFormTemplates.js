/**
 * Script to create default form templates for different medical specialties
      ...
      pages: [
        {
          ...
          elements: [
            { id: "demo_age", type: "number", label: "Age", required: true, placeholder: "Enter your age" },
            { id: "demo_height_feet", type: "number", label: "Height (feet)", required: true, placeholder: "5" },
            { id: "demo_height_inches", type: "number", label: "Height (inches)", required: true, placeholder: "8" },
            { id: "demo_current_weight", type: "number", label: "Current Weight (lbs)", required: true },
            { id: "demo_goal_weight", type: "number", label: "Goal Weight (lbs)", required: false },
            { id: "demo_gender", type: "select", label: "Gender", required: true,
              options: [
        ...
        },
        {
          ...
          elements: [
            { id: "medical_diabetes", type: "radio", label: "Do you have diabetes or pre-diabetes?", required: true,
              options: [
            ...
            { id: "medical_thyroid", type: "radio", label: "Do you have any thyroid conditions?", required: true,
              options: [
            ...
            { id: "medical_heart", type: "radio", label: "Do you have any heart conditions?", required: true,
              options: [
                { id: "heart_yes", value: "yes", label: "Yes" },
                { id: "heart_no", value: "no", label: "No" }
              ]
            },
            { id: "medical_eating_disorders", type: "radio", label: "Have you ever been diagnosed with an eating disorder?", required: true,
              options: [
                { id: "eating_yes", value: "yes", label: "Yes" },
                { id: "eating_no", value: "no", label: "No" }
              ]
            },
            { id: "medical_medications", type: "textarea", label: "Current Medications", required: false, 
              placeholder: "List all current medications, including dosages" },
            { id: "medical_allergies", type: "textarea", label: "Known Allergies", required: false,
        ...
        },
        {
          ...
          elements: [
            { id: "weight_highest", type: "number", label: "Highest Adult Weight (lbs)", required: false },
            { id: "weight_lowest", type: "number", label: "Lowest Adult Weight (lbs)", required: false },
            { id: "weight_attempts", type: "textarea", label: "Previous Weight Loss Attempts", required: false,
              placeholder: "Describe any diets, programs, or methods you've tried" },
            { id: "weight_timeline", type: "select", label: "When would you like to reach your goal weight?", required: true,
              options: [
            ...
            { id: "weight_motivation", type: "textarea", label: "What motivates you to lose weight?", required: true,
      ...
      pages: [
        {
          ...
          elements: [
            ...
            { id: "demo_gender", type: "select", label: "Gender Identity", required: true,
              options: [
                { id: "male", value: "male", label: "Male" },
                { id: "female", value: "female", label: "Female" },
            ...
            { id: "demo_relationship", type: "select", label: "Relationship Status", required: true,
              options: [
        ...
        },
        {
          ...
          elements: [
            { id: "symptom_primary", type: "textarea", label: "Primary Concern", required: true,
              placeholder: "Please describe your main concern in detail" },
            { id: "symptom_duration", type: "select", label: "How long have you experienced this concern?", required: true,
              options: [
            ...
            { id: "symptom_severity", type: "radio", label: "How would you rate the severity of your concern?", required: true,
              options: [
        ...
        },
        {
          ...
          title: "Medical History",
          elements: [
            { id: "medical_conditions", type: "checkbox", label: "Do you have any of these conditions?", required: false,
              options: [
            ...
            { id: "medical_allergies", type: "textarea", label: "Drug Allergies", required: false,
    ...
    contentBody: {
      ...
      pages: [
        ...
        },
        {
          ...
          elements: [
            { id: "hair_loss_age", type: "number", label: "At what age did you first notice hair loss?", required: true },
            { id: "hair_loss_pattern", type: "radio", label: "Where is your hair loss most noticeable?", required: true,
              options: [
            ...
            { id: "hair_loss_rate", type: "radio", label: "How would you describe the rate of your hair loss?", required: true,
              options: [
            ...
            { id: "family_history", type: "radio", label: "Do you have a family history of hair loss?", required: true,
              options: [
        ...
        },
        {
          ...
          elements: [
            { id: "previous_treatments", type: "checkbox", label: "Have you tried any of these treatments?", required: false,
              options: [
            ...
            { id: "treatment_goals", type: "textarea", label: "What are your hair loss treatment goals?", required: true,
              placeholder: "e.g., Stop further loss, regrow hair, improve confidence" },
            { id: "medical_conditions", type: "textarea", label: "Relevant Medical Conditions", required: false,
...
export const createDefaultFormTemplates = async () => {
  try {
    ...
    console.log('✅ All default form templates created successfully!');
    return { success: true };
  } catch (error) {
...
if (typeof window === 'undefined' && import.meta.url === `file://${process.argv[1]}`) {
  createDefaultFormTemplates().then(() => {
    process.exit(0);
  });
}