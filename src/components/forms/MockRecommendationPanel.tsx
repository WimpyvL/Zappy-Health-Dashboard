...
interface MockRecommendationPanelProps {
...
export const MockRecommendationPanel: React.FC<MockRecommendationPanelProps> = ({
  formData,
  config,
  ...
  useEffect(() => {
    const generateRecommendations = async () => {
      ...
      if (config && !mockRecommendationService.shouldTriggerRecommendations(formData, config)) {
        return;
      }
      ...
      try {
        ...
        const recs = await mockRecommendationService.generateRecommendations(
          formData, 
          ...
          <div className="pt-2 border-t">
            <p className="text-xs text-muted-foreground text-center">
              <span className="inline-flex items-center space-x-1">
                <span>🤖</span>
                <span>Mock recommendations based on your form responses. Real system uses AI for personalized suggestions.</span>
              </span>
            </p>
          </div>
        )}
...
export default MockRecommendationPanel;
