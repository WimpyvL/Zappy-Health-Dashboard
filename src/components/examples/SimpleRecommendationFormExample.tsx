...
import { MockEnhancedFormRenderer } from '@/components/ui/mock-enhanced-form-renderer';
...
export const SimpleRecommendationFormExample: React.FC = () => {
      ...
      <div className="mb-6 text-center">
        ...
        <div className="mt-4 p-4 bg-yellow-50 border border-yellow-200 rounded-lg">
          <p className="text-sm text-yellow-800">
            <strong>Note:</strong> This demo uses mock recommendations since AI services require server-side configuration. 
            The real system will generate personalized AI recommendations based on your form responses.
          </p>
        </div>
      </div>
      
      <MockEnhancedFormRenderer
...
export default SimpleRecommendationFormExample;
