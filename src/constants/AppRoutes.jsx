...
const EditSessionPage = React.lazy(() => import('../app/dashboard/sessions/[id]/page.tsx'));
...
const AuditLog = React.lazy(() => import('../app/dashboard/admin/audit-log/page.tsx'));
const Providers = React.lazy(() => import('../app/dashboard/admin/providers/page.tsx'));
const Pharmacies = React.lazy(() => import('../app/dashboard/admin/pharmacies/page.tsx'));
const Discounts = React.lazy(() => import('../app/dashboard/admin/discounts/page.tsx'));
const Tags = React.lazy(() => import('../pages/admin/TagManagement.jsx'));
const Products = React.lazy(() => import('../app/dashboard/admin/products/page.tsx'));
const Resources = React.lazy(() => import('../app/dashboard/admin/resources/page.tsx'));
const Insurance = React.lazy(() => import('../app/dashboard/insurance/page.tsx'));
const Calendar = React.lazy(() => import('../app/dashboard/calendar/page.tsx'));
