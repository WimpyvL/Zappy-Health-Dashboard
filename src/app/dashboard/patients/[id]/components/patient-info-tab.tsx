...
import { User, Heart, FileText, CreditCard, Upload } from "lucide-react";
      ...
      <Card>
        ...
        <CardContent>
          <div className="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-5 gap-6">
            <InfoField label="Full Name" value="Jane Smith" />
            <InfoField label="Date of Birth" value="mm/dd/yyyy" />
            <InfoField label="Email" value="jane.smith@example.com" />
            <InfoField label="Phone" value="098-765-4321" />
      ...
      <Card className="bg-cyan-50/50">
        ...
        <CardContent>
            <div className="grid md:grid-cols-3 gap-6">
                <InfoField label="Insurance Provider" value="-" />
                <InfoField label="Policy Number" value="-" />
                <div>
      ...
      <Card className="bg-yellow-50/50">
        <CardHeader className="flex flex-row items-center justify-between">
          <div className="flex items-center gap-3">
            ...
            <CardTitle className="text-lg">Subscription & Orders</CardTitle>
          </div>
          <Button>Pay Balance</Button>
        </CardHeader>
        <CardContent>
            <div className="bg-blue-100/60 p-4 rounded-lg flex items-center justify-between">
                <div>
                    <h4 className="font-semibold">No active subscription</h4>
                    <p className="text-xs text-muted-foreground">Started: Dec 1, 2024 • Next billing: Feb 1, 2025</p>
                </div>
                <div className="text-right">
                    <p className="text-sm font-semibold">No pricing info</p>
                    <p className="text-xs text-muted-foreground">$127.50 due</p>
                </div>
            </div>

            <div className="mt-6">
                <h4 className="font-semibold text-sm mb-2">Active Orders</h4>
                <div className="border rounded-lg p-4 text-center">
                    <p className="text-sm text-muted-foreground">No active orders found in database</p>
                </div>
